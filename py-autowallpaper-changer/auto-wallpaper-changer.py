...
for root, dirs, files in os.walk("/root/Pictures/desktop/."):     #change the directory to your specified one
...
if count != 0:
    ...
    os.system("/usr/bin/gsettings set org.gnome.desktop.background picture-uri /root/Pictures/desktop/" + "\'" + wallpaper + "\'")
    exit()
else:
